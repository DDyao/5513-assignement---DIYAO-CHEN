...
## As we can see from the graph, the games released by Nintendo, the Wil platform has the best sales. GB and DS platform also performs well.on the other hand,the GC platform has the worst sales. 

# Conclusion
## Talk about the Nintendo company future strategy.Account to the graph*Nintendo's platform performance* and table*Average of all platform in the top1000 hot games sell*.I consider they should Put in more force to develop  Will platform's vedio games. On the other hand, Nintendo company should be relatively less invested in the GC platform. The company can also increase the development of GB and DS platforms.
